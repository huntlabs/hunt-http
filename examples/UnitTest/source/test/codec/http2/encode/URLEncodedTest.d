...
public class URLEncodedTest {
    ...
    void testUrlEncoded() {
        ...
        // url_encoded.decode("Name_1=Value_1");
        // string r = url_encoded.encode();
        // warning(r);
        // assertEquals("simple encode", "Name_1=Value_1", url_encoded.encode());
    ...
    //     // FIXME: Needing refactor or cleanup -@zhangxueping at 2020-11-25T19:32:18+08:00
    //     // 
    ...
    public void testUtf8()
        ...
        string expected = cast(string)(ConverterUtils.fromHexString(hex));
    ...
    public void testUtf8_MultiByteCodePoint() {
        ...
        assertThat(url_encoded.getString("text"), (expected));
    }
}
