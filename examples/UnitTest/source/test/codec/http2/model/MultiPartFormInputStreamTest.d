...
class MultipartFormInputStreamTest {
    ...
    void testSimple() {
        string contentType = "multipart/form-data; boundary=FireflyHttpClientBoundary1nuoxtn9bhp9aeu2; charset=ISO-8859-1";
        string str = "--FireflyHttpClientBoundary1nuoxtn9bhp9aeu2\r\n" ~
                "Content-Disposition: form-data; name=\"test1\"\r\n" ~
                "Content-Type: text/plain;charset=UTF-8\r\n" ~
                "\r\n" ~
                "hello multi part1\r\n" ~
                "--FireflyHttpClientBoundary1nuoxtn9bhp9aeu2\r\n" ~
