...
class HpackContextTest {
    ...
    void testGetAddStatic() {
        ...
        HttpField old = ctx.get(methodGet).getHttpField();

        assertEquals(methodGet, old);
        ...
        // FIXME: Needing refactor or cleanup -@zxp at 6/29/2018, 4:31:36 PM
        // 
        ...
        // Look again and should see dynamic version
        assertEquals(methodGet, ctx.get(methodGet).getHttpField());
        // FIXME: Needing refactor or cleanup -@zxp at 6/29/2018, 4:32:31 PM
        // 
        // assertFalse(methodGet == ctx.get(methodGet).getHttpField());
        assertFalse(ctx.get(methodGet).isStatic());
        assertFalse(e0 == e1);
