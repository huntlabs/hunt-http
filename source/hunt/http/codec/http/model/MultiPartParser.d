...
//     static byte TAB = 0x09;
//     static byte LINE_FEED = 0x0A;
//     static byte CARRIAGE_RETURN = 0x0D;
//     static byte SPACE = 0x20;
//     static byte[] CRLF =
//             {CARRIAGE_RETURN, LINE_FEED};
//     static byte SEMI_COLON = (byte) ';';
...
//     private static EnumSet<State> __delimiterStates = EnumSet.of(State.DELIMITER, State.DELIMITER_CLOSE, State.DELIMITER_PADDING);
...
//     /* ------------------------------------------------------------------------------- */
//     MultiPartParser(Handler handler, string boundary) {
//         _handler = handler;
...
//         default bool headerComplete() {
//             return false;
//         }

//         default bool content(ByteBuffer item, bool last) {
//             return false;
//         }

//         default bool messageComplete() {
//             return false;
//         }
...
//     /* ------------------------------------------------------------------------------- */
//     
//     private static class IllegalCharacterException :IllegalArgumentException {
...
//             warningf(format("Illegal character 0x%X in state=%s for buffer %s", ch, state, BufferUtils.toDetailString(buffer)));
//         }
//     }
// }
